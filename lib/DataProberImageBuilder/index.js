...
DataProberImageBuilder.prototype.getProbeLine = function(axisIdx) {
    var fieldData = { name: this.getField(), data: [] },
        probeData = { xRange: [ 0 , 100], fields: [fieldData] }, // FIXME xRange based on dimension/origin/spacing
        axisToProbe = -1,
    ...
    if(axisToProbe !== -1) {
        ...
        console.log('Offset computation: ' +this.probeXYZ[axisMapping[1]] + ' x ' + width + ' => ' + offset);
