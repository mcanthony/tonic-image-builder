var CanvasOffscreenBuffer = require('../CanvasOffscreenBuffer'),
    ...
    PROBE_LINE_READY_TOPIC = 'chart-data-xyz',
    PROBE_CHANGE_TOPIC = 'probe-location-change',
    dataMapping = {
        renderXY: {
            idx: [0,1,2],
...
DataProberImageBuilder.prototype.TopicProbeLineReady = function() {
    return PROBE_LINE_READY_TOPIC;
};

DataProberImageBuilder.prototype.TopicProbeChange = function() {
    return PROBE_CHANGE_TOPIC;
};
