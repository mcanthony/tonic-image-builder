...
export default function QueryDataModelImageBuilder(queryDataModel) {
    ...
    this.onLoadCallback = (() => {
        this.lastQueryImage.removeListener('load', this.onLoadCallback);
        this.render();
    });
...
QueryDataModelImageBuilder.prototype.render = function() {
    ...
    if(this.lastQueryImage.complete) {
        ...
        this.lastQueryImage.addListener('load', this.onLoadCallback);
    }
};
...
QueryDataModelImageBuilder.prototype.TopicImageReady = function() {
