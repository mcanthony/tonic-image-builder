...
CompositeImageBuilder.prototype.update = function() {
    console.log('request fetch from composite image builder from update');
...
CompositeImageBuilder.prototype.render = function() {
    if(!this.sprite) {
        console.log('request fetch from composite image builder from render');
        this.queryDataModel.fetchData();
        return;
    }
    if(this.query === null) {
...
CompositeImageBuilder.prototype.TopicImageReady = function() {
