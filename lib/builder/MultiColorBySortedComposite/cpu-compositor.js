...
export default function CPUCompositor(queryDataModel, imageBuilder, colorHelper) {
...
CPUCompositor.prototype.updateData = function(data) {
...
CPUCompositor.prototype.render = function() {
    if (!this.orderData) {
        return null;
    }
...
CPUCompositor.prototype.destroy = function() {
...
CPUCompositor.prototype.getLightProperties = function() {
    return {};
}

// --------------------------------------------------------------------------

CPUCompositor.prototype.setLightProperties = function(lightProps) {
