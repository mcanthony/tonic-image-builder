...
PixelOperationImageBuilder.prototype.setOperation = function(expression, dependencyList) {
...
PixelOperationImageBuilder.prototype.updateOperationFunction = function() {
    ...
    for(var key in this.data) {
        functionBody.push('var $ = data.$.data[i];'.replace(/$/g, key));
    }
    functionBody.push('return $;'.replace(/$/g, this.operation));
